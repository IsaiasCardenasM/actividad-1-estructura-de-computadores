...
resultado: .asciiz "El número menor es: "                                                       # Mensaje para mostrar el resultado
...
fn_solicitar_cantidad_números:
    ...
    li $t1, 2147483647      # Cargar el valor máximo de un entero en $t1

    # Bucle para leer los números
    li $t2, 0   # Inicializar el contador de números ingresados en 0

fn_leer_numeros:
    beq $t2, $t0, fn_encontrar_minimo  # Si se han ingresado todos los números, ir a fn_encontrar_minimo
    ...
    # Comparar con el menor número actual
...
fn_actualizar_minimo:
    move $t1, $t3  # Actualizar el menor número con el valor de $t3
